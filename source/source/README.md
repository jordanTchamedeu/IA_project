# Hex Game
The objective of this project is to propose and implement one (or more!) strategies for the game of Hex. To do this, you will find here the code allowing you to model the game (classes implementing the rules of the game, UI, etc.).
